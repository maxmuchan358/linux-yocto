...
struct pdmp_reg_map_t kdmp_pcireg_map[] = {
	...
	{REG_LPC_PCI_CFG,	0, 0x0100, IDX_NON, 0, 0x0300},
	{REG_SATA_PCI_CFG,	0, 0x0100, IDX_NON, 0, 0x0400},
	{REG_SMBUS_PCI_CFG,	0, 0x0100, IDX_NON, 0, 0x0500},
	{REG_VIRTIO_PCI_CFG,	0, 0x0100, IDX_NON, 0, 0x0600},
	{REG_PCIE_RP_PCI_CFG,	0, 0x0100, IDX_NON, 0, 0x0700},
	{REG_TEST_DEV_PCI_CFG,	0, 0x0100, IDX_NON, 0, 0x0800},
	{REG_NET_DEV_PCI_CFG,	0, 0x0100, IDX_NON, 0, 0x0900},
	{REG_STOR_DEV_PCI_CFG,	0, 0x0100, IDX_NON, 0, 0x0a00},
	{REG_PCIE_DEV_PCI_CFG, 0x0100, 0x0300, IDX_NON, 0, 0x0b00},
};
...
struct pdmp_reg_map_t kdmp_ioreg_map[] = {
	...
	{REG_PCIE_DEV_MMIO, 0x0000, 0x0400, IDX_NON, 0, 0x0b40},
	/* q35 stdvga BAR2 MMIO */
	{REG_VGA_DEV_MMIO, 0x0000, 0x1000, IDX_NON, 0, 0x1000},
	/* q35 e1000e BAR0 MMIO */
	{REG_E1000E_DEV_MMIO, 0x0000, 0x1000, IDX_NON, 0, 0x2000},
	/* q35 e1000e BAR2 PIO */
	{REG_E1000E_DEV_IO, 0x0000, 0x0020, IDX_NON, 0, 0x3000},
	/* q35 ahci BAR5 MMIO */
	{REG_SATA_DEV_MMIO, 0x0000, 0x1000, IDX_NON, 0, 0x3100},
	/* q35 ahci BAR4 PIO */
	{REG_SATA_DEV_IO, 0x0000, 0x0020, IDX_NON, 0, 0x4100},
	/* q35 virtio-pci BAR1 MMIO */
	{REG_VIRTIO_DEV_MMIO, 0x0000, 0x1000, IDX_NON, 0, 0x4200},
	/* q35 virtio-pci BAR4 pref MMIO */
	{REG_VIRTIO_DEV_PMMIO, 0x0000, 0x1000, IDX_NON, 0, 0x5200},
	/* q35 virtio-pci BAR0 PIO */
	{REG_VIRTIO_DEV_IO, 0x0000, 0x0040, IDX_NON, 0, 0x6200},
	/* q35 pcie-root-port BAR0 MMIO */
	{REG_PCIE_RP_MMIO, 0x0000, 0x1000, IDX_NON, 0, 0x6300},
};
